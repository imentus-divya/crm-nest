...
export class NewMig1704802223146 implements MigrationInterface {
    name = 'NewMig1704802223146'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "first_name" character varying NOT NULL, "last_name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "username" character varying NOT NULL, "refresh_token" character varying, "expiry_token" TIMESTAMP, "tenant_id" integer NOT NULL, "company_id" integer NOT NULL, "created_date" TIMESTAMP NOT NULL DEFAULT NOW(), "active" boolean NOT NULL DEFAULT true, "role_id" integer, "country_code" integer, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
